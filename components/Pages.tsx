    ...
    return (
        <div className={`min-h-screen ${sysConfig ? 'bg-black text-green-500' : 'bg-[#F8F3E6] text-[#3A3A3A]'}`}>
            ...
            <div className="relative h-[50vh] bg-[#3A3A3A] overflow-hidden flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?q=60&w=1000&auto=format&fit=crop&fm=webp" width="1200" height="675" fetchPriority="high" loading="eager" decoding="async" className="absolute inset-0 w-full h-full object-cover opacity-40" alt="Hair Transplant"/>
