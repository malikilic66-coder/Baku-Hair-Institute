...
export default function App() {
  ...
  return (
    <div className={`min-h-screen font-sans transition-colors duration-700 selection:bg-[#7F6A47] selection:text-[#F8F3E6] ${theme.bg} ${sysConfig ? 'font-mono' : ''}`}>
      ...
      {/* --- NAVBAR --- */}
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-500 ${theme.navBg}`}>
        <div className="container mx-auto px-6 h-full">
          <div className="relative flex items-center justify-between h-full">
            ...
            {/* Mobile Toggle */}
            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className={`lg:hidden interactive ${theme.navText} z-[101] relative`} aria-label="Menyunu aç">
